...
function getTotalEstimatedTime() {
  ...
  var services_api = "http://services.sc-ctsi.org/1/service_agreements/";
  $jq.ajax({
...
function addTotalEstimatedTimeHTML(estimated_total_time, remaining_time) {
  ...
  var html = '';
  html = "<div id='estimated-total-time'>Total Estimated Time: " + estimated_total_time + "</div>" + "<div id='remaining-time'>Remaining Time: " + remaining_time + "</div>";
